...
public class FileUploadServlet extends HttpServlet {
	...
	private void setInitialData(HttpSession session) throws SQLException {
		...
		this.awsCredentials = (BasicAWSCredentials) this.getServletContext()
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			HttpSession session = request.getSession();
				...
				/**
				 * FYI: this id is used for loadgenerator....but the sql
				 * constrain forbid us to complete insert of invalid user id...
				 * Codes leave here just in case we will get the super
				 * privilege.
				 */
				// User ID
