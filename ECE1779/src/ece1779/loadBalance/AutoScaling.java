...
public class AutoScaling extends TimerTask {
	...
	public AutoScaling(BasicAWSCredentials awsCredentials, double expandThreshold,
			double shrinkThreshold, int growRatio, int shrinkRatio) {
	...
	public void run() {
		...
		System.out.println("[AutoScaling] Current average utilization:" + avg
				+ " || expand threshold:" + expandThreshold
				+ " || shrinkThreshold:" + shrinkThreshold + "|| shrinkRatio:"
				+ shrinkRatio + "|| growRatio:" + growRatio);
